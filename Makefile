# This Makefile is for the CGI::Application::Plugin::DetectAjax extension to perl.
#
...
#     EXE_FILES => []
#     INSTALLDIRS => q[site]
#     NAME => q[CGI::Application::Plugin::DetectAjax]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], CGI::Application=>q[0] }
#     VERSION_FROM => q[lib/CGI/Application/Plugin/DetectAjax.pm]
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = CGI::Application::Plugin::DetectAjax
NAME_SYM = CGI_Application_Plugin_DetectAjax
VERSION = 0.04
...
MAKE = make
FULLEXT = CGI/Application/Plugin/DetectAjax
BASEEXT = DetectAjax
PARENT_NAME = CGI::Application::Plugin
DLBASE = $(BASEEXT)
VERSION_FROM = lib/CGI/Application/Plugin/DetectAjax.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/CGI/Application/Plugin/DetectAjax.pm
...
TO_INST_PM = lib/CGI/Application/Plugin/DetectAjax.pm

PM_TO_BLIB = lib/CGI/Application/Plugin/DetectAjax.pm \
...
DISTNAME = CGI-Application-Plugin-DetectAjax
DISTVNAME = CGI-Application-Plugin-DetectAjax-0.04
...
manifypods : pure_all  \
	lib/CGI/Application/Plugin/DetectAjax.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/CGI/Application/Plugin/DetectAjax.pm $(INST_MAN3DIR)/CGI::Application::Plugin::DetectAjax.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               CGI-Application-Plugin-DetectAjax' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '    CGI::Application:  0' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="CGI::Application" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/CGI/Application/Plugin/DetectAjax.pm blib/lib/CGI/Application/Plugin/DetectAjax.pm 
